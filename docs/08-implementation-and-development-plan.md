...
**Phase 0 (Wedge) and most of Phase 1 (Trust) are built and shipped** — github.com/samdotson61/Tessera (public), 165 passing tests + CI (v0.10.0). What actually shipped, and where it diverged from the plan below:
