...
**Phase 0 (Wedge) and most of Phase 1 (Trust) are built and shipped** — github.com/samdotson61/Tessera (public), 189 passing tests + CI (v0.12.0). What actually shipped, and where it diverged from the plan below:
