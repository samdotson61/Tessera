...
- **Not yet built:** Phase 2 (closed active-learning retrain loop), Phase 3 (per-customer distillation), Phase 4 (cross-task Composer). The Phase 0 / Phase 1 sections below now read as a record of what was done; Phase 2 through Phase 4 are the forward plan.
